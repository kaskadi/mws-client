...
class FulfillmentOutboundShipment extends Section {
  ...
  getFulfillmentPreview (opt) {
    opt.Action = 'GetFulfillmentPreview'
    if (parent.mockUp) {
      return {
  ...
  createFulfillmentOrder (opt) {
    opt.Action = 'CreateFulfillmentOrder'
    if (parent.mockUp) {
      return {
  ...
  updateFulfillmentOrder (opt) {
    opt.Action = 'UpdateFulfillmentOrder'
    if (parent.mockUp) {
      return {
  ...
  listAllFulfillmentOrders (opt) {
    opt.Action = 'ListAllFulfillmentOrders'
    if (parent.mockUp) {
      return {
  ...
  getFulfillmentOrder (opt) {
    opt.Action = 'GetFulfillmentOrder'
    if (parent.mockUp) {
      return {
  ...
  getPackageTrackingDetails (opt) {
    opt.Action = 'GetPackageTrackingDetails'
    if (parent.mockUp) {
      return {
  ...
  cancelFulfillmentOrder (opt) {
    opt.Action = 'CancelFulfillmentOrder'
    if (parent.mockUp) {
      return {
  ...
  listReturnReasonCodes (opt) {
    opt.Action = 'ListReturnReasonCodes'
    if (parent.mockUp) {
      return {
  ...
  createFulfillmentReturn (opt) {
    opt.Action = 'CreateFulfillmentReturn'
    if (parent.mockUp) {
      return {
